...
import src.utils.rcf_crf

matplotlib.use('Agg')
import matplotlib.pyplot as plt
from data_loader import BSDS_RCFLoader_original as BSDS_RCFLoader
...
parser.add_argument('--tmp', help='tmp folder', default='tmp/RCF_stepsize15')
# ================ dataset
